...
if (isset($_POST["add_to_cart"])) {
    ...
    if (isset($_SESSION["shopping_cart"])) {
        ...
        if (!in_array($_GET["product_id"], $product_id_array)) {
            ...
            echo "<script>window.location='index.php?dashboard=dogs-paixnidia'</script>";
        } else {
...
$sql = "SELECT * FROM product WHERE category = 'Παιχνίδια'";
    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            ...
            <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                <form method="post" action="index.php?dashboard=dogs-paixnidia&action=add&product_id=<?php echo $row['product_id'] ?>">
